...
namespace Azure.Security.KeyVault.Keys.Cryptography
{
    ...
    /// 
    /// </summary>
    public class RemoteCryptographyClient : ICryptographyProvider
    {
        private Uri _keyId;
        ...
        public RemoteCryptographyClient(Uri keyId, TokenCredential credential, RemoteCryptographyClientOptions options)
        {
